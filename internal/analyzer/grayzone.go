...
//
// The returned function matches library.GrayZoneDecider and is assignable to
// it without this package importing the domain.
func GrayZoneDecision(b backend.Backend, binaryPath string, timeout time.Duration) func(context.Context, types.Topic, types.TopicRef) (bool, error) {
...
// parsing prose.
func grayZonePrompt(candidate types.Topic, nearest types.TopicRef) string {
	return fmt.Sprintf(
