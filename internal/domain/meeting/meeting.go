// Package meeting is patro's domain model: what a recorded meeting is once
// it has been transcribed and understood.
//
// Everything here is plain data with no dependencies — not a bag of shared
// structs, but the vocabulary the rest of the program is written in. It was
// called "types", which described its Go-ness rather than its subject.
package meeting
